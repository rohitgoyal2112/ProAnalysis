// $ANTLR 3.4 TheLang.g 2015-09-19 18:21:01
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final TheLangParser.stmt_return stmt() throws RecognitionException {
        ...
        try {
            ...
            // TheLang.g:101:6: ( assignStmt | skipStmt | readStmt | writeStmt | ifStmt | whileStmt )
            int alt11=6;
            switch ( input.LA(1) ) {
            case IDENTIFIER:
                {
    ...
    // TheLang.g:109:1: assignStmt : IDENTIFIER ( LBRACKET aexpr RBRACKET )? ASSIGN aexpr SEMI ;
    public final TheLangParser.assignStmt_return assignStmt() throws RecognitionException {
        ...
        try {
            ...
            // TheLang.g:109:12: ( IDENTIFIER ( LBRACKET aexpr RBRACKET )? ASSIGN aexpr SEMI )
            // TheLang.g:109:14: IDENTIFIER ( LBRACKET aexpr RBRACKET )? ASSIGN aexpr SEMI
            {
            root_0 = (CommonTree)adaptor.nil();
            ...
            // TheLang.g:109:25: ( LBRACKET aexpr RBRACKET )?
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // TheLang.g:109:26: LBRACKET aexpr RBRACKET
                    {
    ...
    // TheLang.g:111:1: skipStmt : SKIP SEMI ;
    public final TheLangParser.skipStmt_return skipStmt() throws RecognitionException {
        ...
        try {
            ...
            // TheLang.g:111:10: ( SKIP SEMI )
            // TheLang.g:111:12: SKIP SEMI
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    // TheLang.g:113:1: readStmt : READ IDENTIFIER ( LBRACKET aexpr RBRACKET )? SEMI ;
    public final TheLangParser.readStmt_return readStmt() throws RecognitionException {
        ...
        try {
            ...
            // TheLang.g:113:10: ( READ IDENTIFIER ( LBRACKET aexpr RBRACKET )? SEMI )
            // TheLang.g:113:12: READ IDENTIFIER ( LBRACKET aexpr RBRACKET )? SEMI
            {
            root_0 = (CommonTree)adaptor.nil();
            ...
            // TheLang.g:113:28: ( LBRACKET aexpr RBRACKET )?
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // TheLang.g:113:29: LBRACKET aexpr RBRACKET
                    {
    ...
    // TheLang.g:115:1: writeStmt : WRITE aexpr SEMI ;
    public final TheLangParser.writeStmt_return writeStmt() throws RecognitionException {
        ...
        try {
            ...
            // TheLang.g:115:11: ( WRITE aexpr SEMI )
            // TheLang.g:115:13: WRITE aexpr SEMI
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "ifStmt"
    // TheLang.g:117:1: ifStmt : IF bexpr THEN ( stmt )+ ELSE ( stmt )+ FI ;
    public final TheLangParser.ifStmt_return ifStmt() throws RecognitionException {
        ...
        try {
            ...
            // TheLang.g:117:8: ( IF bexpr THEN ( stmt )+ ELSE ( stmt )+ FI )
            // TheLang.g:117:10: IF bexpr THEN ( stmt )+ ELSE ( stmt )+ FI
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    // TheLang.g:119:1: whileStmt : WHILE bexpr DO ( stmt )+ OD ;
    public final TheLangParser.whileStmt_return whileStmt() throws RecognitionException {
        ...
        try {
            ...
            // TheLang.g:119:11: ( WHILE bexpr DO ( stmt )+ OD )
            // TheLang.g:119:13: WHILE bexpr DO ( stmt )+ OD
            {
            root_0 = (CommonTree)adaptor.nil();
    ...
    // $ANTLR start "program"
    // TheLang.g:121:1: program : PROGRAM ( decl )* ( stmt )+ END ;
    public final TheLangParser.program_return program() throws RecognitionException {
        ...
        try {
            ...
            // TheLang.g:121:9: ( PROGRAM ( decl )* ( stmt )+ END )
            // TheLang.g:121:11: PROGRAM ( decl )* ( stmt )+ END
            {
            root_0 = (CommonTree)adaptor.nil();
