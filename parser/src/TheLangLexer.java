...
public class TheLangLexer extends Lexer {
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // TheLang.g:124:9: ( '(*' ( options {greedy=false; } : . )* '*)' )
            // TheLang.g:124:11: '(*' ( options {greedy=false; } : . )* '*)'
            {
            match("(*"); 



            // TheLang.g:124:16: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mINTEGER() throws RecognitionException {
        try {
            int _type = INTEGER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // TheLang.g:127:9: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
            // TheLang.g:127:11: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            {
            // TheLang.g:127:11: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // TheLang.g:127:18: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 

                    // TheLang.g:127:27: ( '0' .. '9' )*
                    loop2:
                    do {
                        int alt2=2;
    ...
    public final void mIDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // TheLang.g:129:12: ( LETTER ( LETTER | '0' .. '9' )* )
            // TheLang.g:129:14: LETTER ( LETTER | '0' .. '9' )*
            {
            mLETTER(); 


            // TheLang.g:129:21: ( LETTER | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
